    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="app-navbar-collapse">
            ...
            <ul class="nav navbar-nav">
                 ...
                 <li><a href="{{ url('/') }}">{{ __('trade.Index') }}</a></li>
                 <li><a href="{{ url('trade') }}">{{ __('trade.Trade') }}</a></li>
                  <li><a href="{{ url('ad/create') }}">{{ __('trade.New Ad') }}</a></li>

                <li><a href="{{ url('/help') }}">{{ __('trade.Help') }}</a></li>
