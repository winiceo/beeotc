                ...
                <div class="table_trade" style="min-height:750px;height: auto;">
                    <table>
                        ...
                        <tr class="bg_change">
                            ...
                            <td>
                                <img style="height:35px;vertical-align: middle;margin-right:10px;width:35px;border-radius: 50%;" src="<?php echo e($order->advertiser->avatar); ?>"><?php echo e($order->advertiser->name); ?>							</td>
                            <td>
