                    ...
                    <div class="div_list" style="display:block;">
                        <div class="usnc_right">
                                        ...
                                        <li>
                                            <div class="rechmid">
                                                ...
                                                <div class="rechipt_box">
                                                    <label>提现地址：</label>
                                                    <input type="text" id="address" readonly value="<?php echo e($address->wallet_address); ?>"></p>
                                                 </div>
                                                <div class="rechipt_box">
                                                    <label>提现数量：</label>
                                                    <div class="iptbox">
                            ...
                            <div class="recharge_list">
                                ...
                                <?php echo $__env->make('wallet.withdrawtable', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

                                <?php echo e($withdraws->links('pagination.default')); ?>
