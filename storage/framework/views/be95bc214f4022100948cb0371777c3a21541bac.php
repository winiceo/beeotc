<?php $__env->startSection('title', $ad->id); ?>
                    ...
                    <div class="ad_left">
                        <div>
                            <div class="user_info">
                                <a href="javascript:void(0)">
                                    <img class="tou" src="<?php echo e(asset('images/user_avatar.png')); ?>">
                                </a>
                                <div class="aduser_names">
                                    <span><?php echo e($ad->user->name); ?></span>
                        ...
                        <table class="danz">
                            <tbody><tr>
                                ...
                                <td class="price"><?php echo e($ad->price); ?> CNY/BTC</td>
                            </tr>
                            <tr>
                                <th>交易限额:
                                </th><td></td>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($ad->payment_window_minutes); ?> 分钟</td>
                            </tr>
                        ...
                        <div class="form-cont">
                            ...
                            <order-create price="<?php echo e($ad->price); ?>" adId="<?php echo e($ad->id); ?>"></order-create>
                            <!-- 购买 -->
